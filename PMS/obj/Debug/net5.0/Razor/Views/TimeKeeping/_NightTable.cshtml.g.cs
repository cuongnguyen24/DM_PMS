#pragma checksum "C:\Users\Admin\source\repos\DM_PMS-master\DM_PMS-master\PMS\Views\TimeKeeping\_NightTable.cshtml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "052910e70049f3e1c3d046d64af1084b8abc2316ee2c8916b83a5415ee9dc47f"
// <auto-generated/>
...
#nullable disable
    ;
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"Sha256", @"052910e70049f3e1c3d046d64af1084b8abc2316ee2c8916b83a5415ee9dc47f", @"/Views/TimeKeeping/_NightTable.cshtml")]
...
#nullable disable
    ...
    ");
            ...
            WriteLiteral(@"row_below: {},
                ...
                ");
            WriteLiteral(@"        cellProperties.readOnly = true;
                ...
                afterChange: function (changes, source) {
                    ...
                    changes.forEach(([row, prop, oldVal, newVal]) => {
                        if (typeof prop === 'number' && prop >= 2 && prop <= 13) { // Cột tháng 1-12
                            // Cập nhật database
  ");
            WriteLiteral(@"                          const rowData = instance.getDataAtRow(row);
                            
                            // Kiểm tra nếu đây là dòng nhân viên (không phải dòng group)
                            if (rowData[0] !== '' && rowData[1] && rowData[1] !== 'Người Quản lý' && rowData[1] !== 'Phòng tổng hợp HĐTV') { // NightTable không có userCode column
          ...
          ");
            WriteLiteral(@"                      });
                                ...
                                if (userId) {
                                    ...
                                    // Gọi API cập nhật
                                    updateNightShiftData(userId, monthIndex, currentYear, newVal);
                                }
                            }
                        }
                    });
            ...
            function calculateHotHeight() {
                ...
                const offset = 360; /");
            WriteLiteral(@"/ Trừ phần header, filter, padding, navbar, ...
        ...
        function updateNightShiftData(userId, month, year, value) {
            const requestData = {
                userId: userId,
                month: month,
                year: year,
        ...
        function showUpdateNotification(type, message) {
            ...
            const notification = $(`
                <div class=""alert ${alertClass} alert-dismissible fade show update-notification"" role=""alert"" style=""position: ");
            WriteLiteral(@"fixed; top: 20px; right: 20px; z-index: 9999; min-width: 300px;"">
